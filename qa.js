...
function renderQaContexts(){
  ...
  const ceo=ensureQaPanel('#ceo','qaContextCeo');if(ceo)ceo.innerHTML=qaContextHtml([3,4,6,17],'CEO与管理层相关问题');
  const roleMap={'院长/CEO':[3,6,17],'市场/客服':[18,19,3],'前台/接待护士':[10,12,13],'咨询师':[1,11,15],'验光师':[8,7,5],'特殊检查技师':[8,7,5],'手术医生':[7,8,15],'手术护士':[6,15,17],'术后随访护士':[15,16,17],'PLS BDM':[3,5,6]};
  renderComplaintQa();
